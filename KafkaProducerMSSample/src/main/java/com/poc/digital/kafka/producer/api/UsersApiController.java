package com.poc.digital.kafka.producer.api;
...
import com.poc.digital.kafka.producer.model.CompanyRequest;
import com.poc.digital.kafka.producer.model.UserObj;
import com.poc.digital.kafka.producer.model.UserRequest;
import com.poc.digital.kafka.producer.service.UserService;
...
public class UsersApiController  {
	 ...
	 */	
	  ...
	  @RequestMapping(method = RequestMethod.POST, value = "/users/createUsingArgs",
	          consumes = MediaType.APPLICATION_JSON_VALUE)
	  public ResponseEntity<Void> createUsersWithListInput(@Context HttpServletRequest requestDto,@RequestBody List<UserObj> userRequest ) {
		  return new ResponseEntity<Void>(HttpStatus.OK);
	  }
	/**
