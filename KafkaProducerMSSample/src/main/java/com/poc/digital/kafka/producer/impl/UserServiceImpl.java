...
package com.poc.digital.kafka.producer.impl;
...
import com.poc.digital.kafka.producer.utils.Producer;
...
public class UserServiceImpl implements UserService{
	...
	public void createUser(UserObj userRequest) {
		...
		String a = userRequest.getPersonUniqueID();
		
		if(userRequest.getPersonUniqueID().length()!=0 && StringUtils.isNumeric(userRequest.getPersonUniqueID()))
		{
